...
- `index.html` – Static landing page with simple styling and CI demo text.[file:1]  
- `package.json` – NPM package metadata (name, version, description, repository, author, license).[file:2][web:12]  
